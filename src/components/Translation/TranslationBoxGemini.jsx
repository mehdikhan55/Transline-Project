...
export default function TranslationBox({ inputLanguage, outputLanguage, inputText, setInputText, outputText, setOutputText, loading, setLoading, error, isFetching }) {
